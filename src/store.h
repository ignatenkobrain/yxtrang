...
extern store store_open2(const char* path1, const char* path2, int compact, void (*)(void*,const uuid*,const char*,int), void* data);
...
extern int store_rem2(store st, const uuid* u, const void* buf, int len);

// Transactions...

extern hstore store_begin(store st, int dbsync);
extern int store_hadd(hstore h, const uuid* u, const void* buf, int len);
extern int store_hrem2(hstore h, const uuid* u, const void* buf, int len);
